    ...
    def update_layout(self, fullscreen, event=None):
        ...
        for i in range(4):
            ...
            if create_monkeys:
                ...
                self.monkey_buttons[i].rect = rect
...
class UpgradeMenu:
    ...
    def update_layout(self, fullscreen, event=None):
        ...
        self.path2_rect = pygame.Rect(self.path1_rect.right + margin, self.rect.y + margin, path_w,
                                      self.height - (margin * 2))
        self.ability_rect = pygame.Rect(self.path2_rect.right + margin, self.rect.y + margin, path_w,
                                        self.height - (margin * 2))
        ...
        if not self.buttons:
            ...
            self.buttons["ability"] = InterfaceButton(self.ability_rect, "ability", (40, 120, 200))
        else:
            ...
            if name == "ability":
                ...
                if monkey.last_ability_time is not None:
                    ...
                    if time_passed < cooldown_total:
                        ...
                        surface.blit(text_surf, (btn.rect.centerx - text_surf.get_width() // 2,
                                                 btn.rect.centery - text_surf.get_height() // 2))
            else:
